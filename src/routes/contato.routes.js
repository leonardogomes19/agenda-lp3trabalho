...
contatoRouter.post("/", async (req, res) => {
    ...
    const {nome, email,telefone,idLocal,idTipoContato} = req.body;

    const resp = await contatoController.create(nome,email,telefone,idTipoContato,idLocal)
...
//alterar depois
    ...
    try {
        const text = "UPDATE id_tipocontato SET descricao = $1 WHERE id = $2";
